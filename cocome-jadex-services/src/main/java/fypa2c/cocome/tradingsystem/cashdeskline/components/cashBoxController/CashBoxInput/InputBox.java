package fypa2c.cocome.tradingsystem.cashdeskline.components.cashBoxController.CashBoxInput;
...
public class InputBox implements IScanner {
	
	private InputBoxGUI gui = new InputBoxGUI();
